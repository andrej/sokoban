...
/**
 * The simple heuristic is simply the distance of the player to the
 * closest box (without taking walls into account) that is not in the goal, and 
 * the minimum distance of all boxes to the closest goal.
 */
